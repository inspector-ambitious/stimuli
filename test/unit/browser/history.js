...
describe('Stimuli.browser.History', function() {
    ...
    beforeEach(function() {
        ...
        history = new Stimuli.browser.History(context);
        ...
        describe('backward', function() {
            ...
            it('should throw an error if you try to go backward when no navigation has occurred', function() {
                try {
                    ...
                    expect(e.toString()).to.contain('Stimuli.browser.History: Can\'t go back.');
       ...
       describe('forward', function() {
            ...
            it('should throw an error if you try to go forward when no navigation has occurred', function() {
                try {
                    ...
                    expect(e.toString()).to.contain('Stimuli.browser.History: Can\'t go forward.');
                    history.scheduler.unlock();
                }
            });
